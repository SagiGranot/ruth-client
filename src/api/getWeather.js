...
export async function getWeather() {
  let weatherInfo;
  const [forcast1, forcast2] = await Promise.all([
    getForcast1(),
    getForcast2(),
  ]);
...
function setWeatherInfo(f1, f2) {
  ...
  weatherInfo.HighTemperature =
    f2.dailyForecasts.forecastLocation.forecast[0].highTemperature;
  weatherInfo.LowTemperature =
    f2.dailyForecasts.forecastLocation.forecast[0].lowTemperature;
  weatherInfo.WindSpeed =
    f2.dailyForecasts.forecastLocation.forecast[0].windSpeed;
  weatherInfo.Humidity =
    f2.dailyForecasts.forecastLocation.forecast[0].humidity;
