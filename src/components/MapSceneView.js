...
import { WeatherSec } from './weatherSection';
  ...
  async componentDidMount() {
    loadModules(
      ...
      .then(async ([Map, SceneView, FeatureLayer, Graphic, Track, Utils]) => {
        ...
        const [deployments, objects, deltas, forcast] = await Promise.all([
          getDeployments(),
          getGeoObjects(),
